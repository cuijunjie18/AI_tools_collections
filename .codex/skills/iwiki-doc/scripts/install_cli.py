...
def main():
    ...
    print()
    print("=" * 50)
    print(f"  iWiki CLI {version} 安装成功！")
    print("=" * 50)
    print()
    if os_name == "windows":
        print("  设置 Token:    $env:IWIKI_TOKEN='your_token'")
        print("  永久生效:      [Environment]::SetEnvironmentVariable('IWIKI_TOKEN','your_token','User')")
    else:
        print("  设置 Token:    export IWIKI_TOKEN=your_token")
    print(f"  查看帮助:      {BINARY_NAME} --help")
    print(f"  检查更新:      {BINARY_NAME} upgrade")
    print()
    print("  Token 申请:    https://tai.it.woa.com/user/pat")
    print("=" * 50)
    print()
